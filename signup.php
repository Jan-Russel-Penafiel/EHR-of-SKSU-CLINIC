...
try {
    ...
    $checkQuery = "SELECT * FROM personal_info_accounts WHERE GmailAccount = '$GmailAccount'";
    ...
    $insertQuery = "INSERT INTO personal_info_accounts (IDNumber, GmailAccount, password) VALUES ('$IDNumber', '$GmailAccount', '$password')"; // No hashed password
