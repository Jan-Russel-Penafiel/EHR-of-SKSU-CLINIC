...
<head>
    ...
    <title>Update Faculty Record</title>
...
<body>
    <header>
        <h1><i class="fas fa-user-md"></i> Update Faculty</h1>
    </header>
            ...
            <form method="POST" action="insert_faculty1.php?IDNumber=<?php echo htmlspecialchars($idNumber); ?>">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="IDNumber" value="<?php echo htmlspecialchars($faculty['IDNumber']); ?>" readonly>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="Complains" required><?php echo htmlspecialchars($faculty['Complains']); ?></textarea>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="Temperature" step="0.1" required 
                                value="<?php echo htmlspecialchars($faculty['Temperature']); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="BloodPressure" required 
                                value="<?php echo htmlspecialchars($faculty['BloodPressure']); ?>" 
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="HeartRate" required 
                                value="<?php echo htmlspecialchars($faculty['HeartRate']); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="RespiratoryRate" required 
                                value="<?php echo htmlspecialchars($faculty['RespiratoryRate']); ?>" 
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" name="Height" step="0.1" required 
                                value="<?php echo htmlspecialchars($faculty['Height']); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="Weight" step="0.1" required 
                                value="<?php echo htmlspecialchars($faculty['Weight']); ?>" 
                    ...
                    <div class="form-group">
                        ...
                        <input type="datetime-local" name="AppointmentDate" required 
                            value="<?php echo htmlspecialchars($faculty['AppointmentDate']); ?>">
                    </div>
                </div>
