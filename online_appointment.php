...
$queryPersonalInfo = "SELECT IDNumber, FirstName, LastName, Course, Yr, Section FROM personal_info WHERE GmailAccount = '$GmailAccount'";
$resultPersonalInfo = mysqli_query($conn, $queryPersonalInfo);

// If user information is found, fill variables
...
$queryAppointmentCount = "SELECT COUNT(*) as appointment_count FROM appointments 
...
// Limit the student to 2 appointments per month
...
<head>
    ...
    <style>
        ...
        body {
            background-image: url(sksu-logo.png);
