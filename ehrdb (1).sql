...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 21, 2024 at 07:26 AM
...
--
-- Dumping data for table `illmed`
--

INSERT INTO `illmed` (`Num`, `IDNumber`, `IllName`, `MedName`, `Temperature`, `BloodPressure`, `Status`, `Appointment_Date`, `years`, `alert_sent`, `Prescription`, `months`) VALUES
(1, 29154, 'Flu', 'Paracetamol', 36.00, '120/80', 'Pending', '2024-12-04 06:56:38', '2024', 0, '2 dosage of paracetamol take that in 2 days', 'December'),
(2, 29154, 'Flu', 'Paracetamol', 41.00, '120/80', 'Pending', '2024-12-09 01:24:47', '2024', 0, 'sada', 'December');
...
INSERT INTO `intv` (`Num`, `IDNumber`, `what_you_do`, `what_is_your_existing_desease`, `have_you_a_family_history_desease`, `have_you_a_allergy`, `years`, `months`) VALUES
(1, 29154, 'Walking', 'N/A', 'N/A', 'N/A', '2024', 'December'),
(2, 29154, 'Walking', 'N/A', 'N/A', 'N/A', '2024', 'December');
...
(1, 'Paracetamol', 'SKSU MAIN CAMPUS', 12, 'November', 2024),
...
INSERT INTO `personal_info` (`Num`, `FirstName`, `LastName`, `IDNumber`, `GmailAccount`, `Birthdate`, `Age`, `Gender`, `Course`, `Yr`, `Section`, `ProfilePicture`, `years`, `months`, `password`) VALUES
(1, 'Jan Russel', 'Elizares Peñafiel', 29154, 'janrusselpenafiel@sksu.edu.ph', '2005-01-17', 19, 'Male', 'Information Technology', 2, 'B', 'downloads/russel.jpg', '2024', 'December', '');
...
--
-- Dumping data for table `personal_info_accounts`
--

INSERT INTO `personal_info_accounts` (`Num`, `IDNumber`, `GmailAccount`, `Password`, `years`, `otp`, `otp_expiry`) VALUES
(60, 29154, 'janrusselpenafiel@sksu.edu.ph', '12345678', '2024', NULL, NULL);
...
--
ALTER TABLE `faculty`
  MODIFY `Num` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=224;
