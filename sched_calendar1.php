...
$GmailAccount = mysqli_real_escape_string($conn, $_SESSION['GmailAccount']);

// Query to get student info for form pre-fill
$queryPersonalInfo = "SELECT IDNumber, FirstName, LastName, Course, Yr, Section 
                      FROM personal_info 
...
// Check how many appointments the student has made in the current month and year
$queryAppointmentCount = "SELECT COUNT(*) as appointment_count 
                          FROM appointments 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $queryInsertAppointment = "INSERT INTO appointments (IDNumber, FirstName, LastName, Course, Yr, Section, Appointment_Date, Appointment_Time, Reason) 
    VALUES ('$IDNumber', '$FirstName', '$LastName', '$Course', '$Year', '$Section', '$appointmentDate', '$appointmentTime', '$reasonForAppointment')";
...
<div id="appointmentModal" class="modal">
    <div class="modal-content">
        ...
        <!-- Appointment Form -->
        <form id="appointmentForm" method="POST" action="online_appointment.php" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                <label class="bold-label">Course:</label>
                <input type="text" name="course" value="<?php echo htmlspecialchars($Course); ?>" readonly>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="bold-label">Section:</label>
